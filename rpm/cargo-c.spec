...
Patch0:         0001-Pin-versions-and-features-for-Rust-1.75.patch
Patch1:         0002-Fix-type-confusion.patch
Patch2:         0003-Overwrite-the-host-triple-with-target-triple-in-SB2.patch
...
install ${TARGET}/cargo-cinstall %{buildroot}%{_bindir}/cargo-cinstall
install ${TARGET}/cargo-ctest %{buildroot}%{_bindir}/cargo-ctest
